    ...
    <Layout noScroll align="start">
      <div className="w-full max-w-xl">
        <div className="surface-card relative overflow-hidden p-8 text-center md:p-10">
          ...
          <h1 className="relative mt-4 text-4xl font-semibold tracking-tight md:text-5xl">
            {t("join_titlePart1")} <span className="text-primary">{t("join_titleHighlight")}</span>
          </h1>
          <p className="relative mx-auto mt-3 max-w-sm text-muted-foreground">
            {t("join_desc")}
          </p>
          <a
            ...
            className="btn-primary relative mt-5 hover:[&]:btn-primary-hover"
          >
            {t("join_button")}
        ...
        <div className="surface-card mt-3 p-5 md:p-6">
